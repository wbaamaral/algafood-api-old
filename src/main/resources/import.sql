...
insert into restaurante (id, nome, taxa_frete, cozinha_id) values (5, 'Panela Mineira', 15, 3);
insert into restaurante (id, nome, taxa_frete, cozinha_id) values (6, 'Panela Brasil', 0.0, 3);
insert into restaurante (id, nome, taxa_frete, cozinha_id) values (7, 'Rei do rango', 0.0, 3);
